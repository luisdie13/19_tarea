...
goat1.diet(); 
// Output será "ReferenceError: dietType is not defined"
 ...
 * propiedad de modelo y le asignaremos el valor 'B-4MI'.
 ...
 * const robot = {
    ...
    Dentro del objeto robot, agregue un método llamado provideInfo. 
    Dentro del cuerpo de provideInfo(), devuelva la siguiente cadena 
    mediante interpolación:

    I am MODEL and my current energy level is ENERGYLEVEL.  

    Reemplace 'MODEL' y 'ENERGYLEVEL' con la propiedad model y el objeto 
    ...
    Ahora, para comprobar si .provideInfo() tiene acceso a las propiedades
